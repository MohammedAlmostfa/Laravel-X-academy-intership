...
class UserController extends Controller
{
    ...
    */
    ...
    public function addrole(string $role, string $user)
    {
        $result =  $this->userService->addRole($role, $user);
        //return the response
        return response()->json([
            'message' => $result['message'],
        ], $result['status']);
    ...
    public function deletrole(string $role, string $user)
    {
        $result =  $this->userService->deleteRole($role, $user);
        //return the response
        return response()->json([
            'message' => $result['message'],
        ], $result['status']);
