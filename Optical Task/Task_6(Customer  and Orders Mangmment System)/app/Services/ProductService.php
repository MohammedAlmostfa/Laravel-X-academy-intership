...
class ProductService
{
    ...
    public function ShowAllProduct()
    {
        try {
            ...
            // Fetch all products with selected fields and paginate
            $products = Product::select(['id', 'name', 'price', 'description'])->paginate(10);

            return $products; // Return the paginator object directly
        } catch (Exception $e) {
